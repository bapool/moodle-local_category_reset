...
$string['processingreset'] = 'Processing Reset...';
$string['deletedgroups'] = 'Deleted {$a} groups';
$string['nodeletepattern'] = 'No delete pattern configured - no groups deleted';
$string['resetcomplete'] = 'Reset Complete';
$string['successfullyreset'] = 'Successfully reset: {$a} courses';
